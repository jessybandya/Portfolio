                                    ...
                                    db.collection('users').doc(auth.user.uid).set({
                                        ...
                                        emailSee:true,
                                          ...
                                          Swal.fire({
                                            ...
                                            text: 'Sucessfully Created an account.\n Welcome Dear Client!',
                                          })
                                          history('/')
                                        })
                                })
...
setCountry(newTeam?.label)
setCountryCode(newTeam?.phone)
}}
...
/>
    ...
    placeholder="Confirm Password" />
        ...
        <SoftBox mt={2} mb={1}>
          <SoftButton className="blinking-button" onClick={completeRegistration} variant="gradient" fullWidth>
          {loading === true ?(

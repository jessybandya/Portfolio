...
var dVTotal = currentUser?.diviworks?.length
  ...
  return (
    <SoftTypography >
      <Header1 profilePhoto={currentUser?.profilePhoto} firstName={currentUser?.firstName} lastName={currentUser?.lastName} email={currentUser?.email} phone={currentUser?.phone} country={currentUser?.country}/>

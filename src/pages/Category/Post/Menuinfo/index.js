    ...
    <div>
      ...
      <TableContainer sx={{ maxHeight: 440 }}>
        <Table stickyHeader aria-label="sticky table">
          ...
          <TableRow>
          <TableCell >
                   <span style={{fontWeight:'bold',color:'#2152ff'}}>Price</span> 
              </TableCell>
              <TableCell >
          ...
          <TableRow>
          <TableCell >
                   <span style={{fontWeight:'bold',color:'#2152ff'}}>Category</span> 
              </TableCell>
              <TableCell >
              {category}
              </TableCell>
          ...
          <TableRow>
          <TableCell >
                   <span style={{fontWeight:'bold',color:'#2152ff'}}>Rating</span> 
              </TableCell>
              <TableCell >
          ...
          <TableRow>              
          <TableCell >
                   <span style={{fontWeight:'bold',color:'#2152ff'}}>Rating Comment</span> 
              </TableCell>
              <TableCell >
                    {status(a)}
              </TableCell>
          ...
          <TableRow>              
          <TableCell >
                   <span style={{fontWeight:'bold',color:'#2152ff'}}>Shop</span> 
              </TableCell>
              <TableCell >

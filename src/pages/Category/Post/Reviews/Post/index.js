...
function Post({ ratedByUid, rating1, ratingComment, ratingTime, reviewId, eventId, firstName, lastName}) {
  ...
  const actions = [
    ...
    <Rating  value={rating1}/> {rating1}/5
    </span>,
  ];
...
function status(x){
  ...
  return (
    <Comment
      ...
      avatar={<Avatar {...stringAvatar(`${currentUser?.firstName} ${currentUser?.lastName}`)} />}
      content={
        <>

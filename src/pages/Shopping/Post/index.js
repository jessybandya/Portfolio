  ...
  return (
    ...
    <article className="list-product">
      ...
      <Link to={`/product-view/${electronicID}`} className="thumbnail">
        {images.length === 0 ?(
          ...
          <>
            ...
            <img className="second-img" style={{height:130,width:'100%',objectFit:'contain'}} src="https://firebasestorage.googleapis.com/v0/b/electrika-store.appspot.com/o/electrika-welcome.jpg?alt=media&token=34abff30-6591-4eef-a761-7b76bd78b982" alt="" />
            </>
        )}
    </Link>
      </div>
      ...
      <div className="product-decs">
        <Link to={`/product-view/${electronicID}`}><span style={{fontSize:14}}>{category}</span></Link>

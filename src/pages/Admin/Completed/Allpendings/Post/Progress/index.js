...
<hr style={{width:'100%'}}/>
<Box onClick={() => handleShowModal1('Pay Status')} style={{marginTop:5,cursor:'pointer'}}>
{paidStatus}
</Box>
</Grid>
    </Grid>
    ...
    <hr style={{width:'100%'}}/>
    <Box onClick={() => handleShowModal1('Total Amount')} style={{marginTop:5,cursor:'pointer'}}>
  ...
  <hr style={{width:'100%'}}/>
  <Box onClick={() => handleShowModal1('Paid Amount')} style={{marginTop:5,cursor:'pointer'}}>
...
<hr style={{width:'100%'}}/>
<Box onClick={() => handleShowModal1('Duration')} style={{marginTop:5,cursor:'pointer'}}>
{dueDate}
</Box>
</Grid>
    </Grid>
  ...
  <Grid item xs={12} sm={4} style={{border:'1px solid #1976d2',borderRadius:8,paddingBottom:5}}>
  <label style={{color:'#BABABA'}}>Product Links({webLinks.length})</label>
  <hr style={{width:'100%'}}/>
  <Box style={{marginTop:5}}>
  <Button
